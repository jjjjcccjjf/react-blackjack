...
import dealerImg from '../../public/dealer.png'
    ...
    return (
        <>
            <div className="flex flex-col justify-center gap-12 h-full items-start bg-[url('/assets/bg.png')] bg-no-repeat bg-cover bg-center ">
                {/* <Splash></Splash> */}
                <div className="flex flex-row items-center gap-2 justify-center place-self-center w-full pr-6 bg-gradient-to-t from-transparent via-[#12192c] to-transparent h-96 floaty mb-64">
            ...
            <div className="absolute bottom-0 left-0 ">
                <div className="h-32 bg-gradient-to-t to-transparent from-[#12192c]"></div>
                <div className="flex flex-col gap-4 justify-center items-center w-full p-6 bg-[#12192c]">
                    ...
                    <div className="flex flex-col gap-4 justify-center items-center w-full border-t border-t-white/25 pt-4 text-white/50">
