    ...
    return (
        <>
            <div className="absolute top-0 h-full w-full flex justify-center items-center transition-opacity duration-300 backdrop-blur-3xl " ref={bannerRef}>
                <div className="w-full h-full tall:w-5/6 tall:h-5/6 taller:h-4/6 flex flex-col items-center justify-center border-y border-y-white/50 backdrop-blur-3xl bg-[#12192c]/95 gap-6 tall:gap-5">
                    ...
                    <ul className="px-8 flex flex-col gap-4 list-disc">
                        <li>
                        ...
                        <li>
                            ACE's value is 11. If you BUST with an ACE, the ACE's value becomes 1 instead.
                        </li>
                    </ul>
